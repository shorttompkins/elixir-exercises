defmodule Issues.CLI do
  ...
  to the various functions that end up gneerating a
  ...
  @doc """
  processes the cli arguments returning :help information or calling
  GithubIssues.fetch
  """
  def process(:help) do
    IO.puts """
  ...
  def process({ user, project, count }) do
    ...
    |> Enum.take(count)
    |> Enum.map(&(Map.take(&1, ["title", "state", "updated_at"])))
  end
